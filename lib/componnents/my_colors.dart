...
class GradiantColors{
  ...
  static const List<Color> tags = [Color.fromARGB(255, 0, 0, 0),Color.fromARGB(255, 150, 150, 150)];
  static const List<Color> seltags = [Color.fromARGB(255, 0, 0, 0),Color.fromARGB(255, 10, 10, 10)];
